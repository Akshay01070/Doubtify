...
const RightSidebar = () => {
  return (
    <div className="hidden md:p-1 md:block md:w-40 fixed xl:top-16 lg:top-12 right-0 h-full bg-[#F5F2FF] shadow-lg p-4 flex flex-col space-y-2  lg:w-1/5 ">
      <div className="h-full bg-white p-4 flex flex-col space-y-2 rounded-lg">
        <h3 className="text-xl md:text-lg mt-8 lg:text-xl text-center font-bold mb-1">Top Categories</h3>
